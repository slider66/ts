export default function FloatWA() {
  return (
    <a
      href="https://wa.me/34645801208?text=Hola%20Toni%2C%20me%20interesa%20una%20escultura%20metálica%20personalizada."
      target="_blank"
      rel="noreferrer"
      ...
      onMouseEnter={e => { e.currentTarget.style.transform = 'scale(1.12)'; e.currentTarget.style.boxShadow = '0 6px 28px rgba(37,211,102,0.55)' }}
